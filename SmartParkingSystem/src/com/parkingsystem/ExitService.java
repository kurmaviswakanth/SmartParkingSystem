...
public class ExitService {
    ...
    public static void processExit(Scanner sc) {
        ...
        long elapsedMinutes = ChronoUnit.MINUTES.between(booking.startTime, LocalDateTime.now());
        ...
        System.out.println("Actual Exit Time: " + LocalDateTime.now().format(DATETIME_DISPLAY_FORMATTER));
        System.out.println("Duration Booked: " + booking.durationHours + " hours (" + bookedMinutes + " mins)");
        System.out.println("Actual Parked Time: " + elapsedMinutes + " mins");
        ...
        if (overstayCharge > 0) {
            long minutesOverstayedActual = ChronoUnit.MINUTES.between(booking.endTime.plusMinutes(DataStore.GRACE_PERIOD_MINUTES), LocalDateTime.now());
