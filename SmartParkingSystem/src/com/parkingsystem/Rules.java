...
public class Rules {
    ...
    public static void displayRulesAndRegulations(Scanner sc) {
        ...
        System.out.println("5. Grace Period: You have a " + DataStore.GRACE_PERIOD_MINUTES + "-minute grace period after your booking ends to exit without penalty.");
        ...
        System.out.println("9. No-Show Policy: Your slot is released if you don't arrive within 15 minutes of your booking start time.");
