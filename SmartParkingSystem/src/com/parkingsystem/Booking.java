...
public class Booking {
    ...
    public long getParkedMinutes() {
        ...
        LocalDateTime effectiveNow = (exitTime != null) ? exitTime : LocalDateTime.now();
        return ChronoUnit.MINUTES.between(arrivalTime, effectiveNow);
    }
    ...
    public boolean isOverstayed(int gracePeriodMinutes) {
        LocalDateTime effectiveNow = (exitTime != null) ? exitTime : LocalDateTime.now();
        return effectiveNow.isAfter(endTime.plusMinutes(gracePeriodMinutes));
    }
    ...
    public double getOverstayCharge(Lot lot, int gracePeriodMinutes) {
        ...
        long minutesOverstayed = ChronoUnit.MINUTES.between(endTime.plusMinutes(gracePeriodMinutes), effectiveNow);
